...
urlpatterns = [
    ...
    # Patient history and utility endpoints
    path('history/<int:pk>/', views.patientHistory, name='patient_history'),
    path('display/', views.display, name='display_appointments'),
    path('add/', views.add, name='add_appointment'),
    
    # Appointment management endpoints
    path('today/', views.AppointmentsToday.as_view(), name='appointment_list'),
    path('doctor/me/', views.AppoinmentsByDoctor.as_view(), name='appointments_by_doctor'),
    path('create/', views.AppointmentsCreate.as_view(), name='appointment_create'),
    path('detail/<int:pk>/', views.AppointmentsDetail.as_view(), name='appointment_detail'),
    path('update/<int:pk>/', views.AppointmentsUpdate.as_view(), name='appointment_update'),
    path('cancel/<int:pk>/', views.AppointmentCancel.as_view(), name='appointment_cancel'),
